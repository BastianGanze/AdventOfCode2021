...
pub fn rotate_point(t1: Transformation, p: Point) -> Point {
...
mod tests {
    ...
    pub fn test_transformations() {
        assert_eq!(
            rotate_point((0, 1, 2, 1, 1, 1), [686, 422, 578]),
            [686, 422, 578]
        );
        assert_eq!(
            rotate_point((1, 0, 2, 1, 1, 1), [686, 422, 578]),
            [422, 686, 578]
        );
        assert_eq!(
            rotate_point((0, 2, 1, 1, 1, 1), [686, 422, 578]),
            [686, 578, 422]
        );
        assert_eq!(
            rotate_point((0, 1, 2, -1, -1, -1), [686, 422, 578]),
